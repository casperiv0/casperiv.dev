  ...
  return (
    <section className="flex flex-col justify-center mx-auto h-[40em]" id="top">
      <div>
        ...
        <h1 className="text-6xl font-bold md:text-7xl lg:text-8xl">Casper Iversen,</h1>
      ...
      <p className="max-w-3xl mt-8 text-gray-300 md:text-xl">
        I am a <Age /> year old programmer and student based in Belgium. I'm a self taught developer
        and I have been programming for about 2 years and still learning new technologies every day,
